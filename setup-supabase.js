...
async function collectSupabaseInfo() {
  ...
  log(
    '\nPor favor, forneça as seguintes informações do seu projeto Supabase:',
    'yellow'
  );
  log(
    '(Você pode encontrar essas informações no painel do Supabase > Settings > API)',
    'yellow'
  );
...
function showNextSteps() {
  ...
  log(
    '\n✨ Sua aplicação agora está configurada para usar o Supabase!',
    'green'
  );
}
