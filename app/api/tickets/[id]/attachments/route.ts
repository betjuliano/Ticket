...
export async function GET(
  ...
  try {
    ...
    if (!canViewTicket) {
      return createErrorResponse('Sem permissão para visualizar este ticket', 403)
    }
...
export async function POST(
  ...
  try {
    ...
    if (!canUpload) {
      return createErrorResponse('Sem permissão para anexar arquivos neste ticket', 403)
    }
    ...
    return createSuccessResponse(attachment, 'Arquivo enviado com sucesso', 201)
