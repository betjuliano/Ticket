...
export default function AuthPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    if (
      ...
      registerData.matricula.length < 5
    ) {
    ...
    if (
      registerData.identificationType === 'telefone' &&
      ...
      <div className="relative w-full max-w-md">
            ...
            >
              ...
              <TabsContent value="register" className="space-y-4 mt-6">
                ...
                <Alert className="bg-blue-500/10 border-blue-500/20 text-blue-200">
                  ...
                  <AlertDescription>
                    <strong>Observação:</strong> Se você não for aluno(a) da
                    UFSM, pode fazer o cadastro igualmente. O sistema é aberto
                ...
                <form onSubmit={handleRegister} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        onChange={e =>
                          updateRegisterData('name', e.target.value)
                        }
                        className="pl-10 bg-white/10 border-white/20 text-white placeholder:text-blue-200 focus:border-blue-400 focus:ring-blue-400"
                        required
                      />
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value: 'matricula' | 'telefone') =>
                        updateRegisterData('identificationType', value)
                      }
                    >
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          onChange={e =>
                            updateRegisterData('matricula', e.target.value)
                          }
                          className="pl-10 bg-white/10 border-white/20 text-white placeholder:text-blue-200 focus:border-blue-400 focus:ring-blue-400"
                          required
                        />
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          onChange={e =>
                            updateRegisterData('telefone', e.target.value)
                          }
                          className="pl-10 bg-white/10 border-white/20 text-white placeholder:text-blue-200 focus:border-blue-400 focus:ring-blue-400"
                          required
                          maxLength={11}
                      ...
                      <p className="text-xs text-blue-300 mt-1">
                        Exemplo: 55999999999 (DDD + número sem espaços ou
                        símbolos)
                      </p>
                    </div>
                  )}
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        onChange={e =>
                          updateRegisterData('confirmPassword', e.target.value)
                        }
                        className="pl-10 pr-10 bg-white/10 border-white/20 text-white placeholder:text-blue-200 focus:border-blue-400 focus:ring-blue-400"
                        required
                      />
        ...
        <div className="text-center mt-8">
          <p className="text-blue-300 text-sm">
            Desenvolvido por Ia projetos - Prof. Juliano 2025 Universidade
