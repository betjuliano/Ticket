          ...
          <Card className="bg-white/10 backdrop-blur-lg border-white/20">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <Button
                  variant="outline"
                  className="border-white/20 text-blue-300 hover:bg-white/10 hover:text-white bg-transparent"
                >
          ...
          <Card className="bg-slate-900 border-neutral-700">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <Button
                  variant="outline"
                  className="border-neutral-700 text-neutral-400 hover:bg-slate-800 hover:text-neutral-300 bg-transparent"
                >
                  <TestTube className="w-4 h-4 mr-2" />
                  Testar Integração
                </Button>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-3 bg-slate-800 rounded">
                  <div>
                    ...
                    <p className="text-xs text-neutral-400">
                      Notificar quando um usuário responder
                    </p>
                  </div>
                ...
                <div className="flex items-center justify-between p-3 bg-slate-800 rounded">
                  <div>
                    ...
                    <p className="text-xs text-neutral-400">
                      Notificar imediatamente para tickets urgentes
                    </p>
                  </div>
